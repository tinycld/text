---
title: Changing font size and family
summary: Pick a font and a point size from the toolbar dropdowns
tags: [font, size, family, formatting]
order: 40
---
...
Both size and family round-trip through `.docx`. A doc opened from Word with explicit font choices keeps them; choices made in the editor are written back to the file so Word readers see the same fonts.
