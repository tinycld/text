...
// NOTE: never place ToolbarTooltip *between* a Menu/Popover `trigger`
// and its Pressable. The surface clones its trigger element to inject
// onPress + a ref it measures for placement; this tooltip is a Fragment
// passthrough on native and would swallow both, so the menu would never
// open. Make the trigger a forwardRef component that wraps its own
// Pressable in the tooltip (see FormatButton and TextColorButton).
